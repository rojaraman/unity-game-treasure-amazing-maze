...
//private var point : int = 100;
public var countText : GUIText;
public var discovered : GUIText;
...
function OnTriggerEnter (other : Collider)
 {
	...
	{
		countText.text= "Points/4000 :" + count.ToString();
		
	}
	function treasuredisc()
	{
	  discovered.text= "HEART FOUND ;) CONGRATS... CLICK EXIT";
	  count=count+6000;
	  countText.text= "Points : " + count.ToString() ;
	  timerText.text= "TIME TAKEN : " + Time.timeSinceLevelLoad.ToString();
	 	}
